...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="keywords"
			content="淘宝店铺管理系统,www.dangg999.com" />
		<meta name="description" content="淘宝店铺管理系统" />
	...
	<body>
		...
		<div id="topMain" align="center" style="width: 920px;">
			<div id="top" style="width: 920px; height: 46px;">
				<div align="left">
					<img src="<%=path %>/img/logo.gif" style="float: left" />
		...
		<div id="main" style="">
			...
			<form id="form1" action="<%=path %>/sys/menu/login" method="post">
				<div id="left">
					<table width="295px" border="0">
						<tr>
							<td colspan="2" style="height: 32px;">
								<span>登录淘宝店铺管理系统</span>
							</td>
						</tr>
						<tr>
							<td height="5px;"></td>
